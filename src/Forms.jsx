...
export default function Forms() {
  ...
  return (
    <div className='container'>
        ...
        <thead> <th>S No.</th><th>Form Title</th><th className='text-center'>Links</th><th className='text-center'>Response</th><th className='text-center'>Activation</th><th></th></thead>
        <tbody>
        {
            forms.map((form, index) =>
                <tr>
                    ...
                    <td className='text-center'>
                        <a className='btn btn-primary mx-3 my-1'  href={"Response/"+form._id}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-fill-check" viewBox="0 0 16 16">  <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm1.679-4.493-1.335 2.226a.75.75 0 0 1-1.174.144l-.774-.773a.5.5 0 0 1 .708-.708l.547.548 1.17-1.951a.5.5 0 1 1 .858.514ZM11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>  
