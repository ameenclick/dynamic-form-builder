        ...
        <div className="row mt-5" align="center">
            <div className="offset-lg-1 col-lg-3 pt-5">
                    <a type="button" className="btn btn-outline-primary p-4 justify-content-center"
                        ...
                        style={{width:"150px"}}
                        href="/Builder">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-palette" viewBox="0 0 16 16">  <path d="M8 5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm4 3a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM5.5 7a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm.5 6a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/> 
            ...
            <div className=" col-lg-3 pt-5">
                <a type="button" className="btn btn-outline-primary p-4 justify-content-center" style={{width:"150px"}}
                    href="/Forms">      
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-list-check" viewBox="0 0 16 16">  
            ...
            <div className="col-lg-3 pt-5">
                    <a className="btn btn-outline-primary p-4 justify-content-center"
                        href='/Respond/'
                        style={{width:"150px"}}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-person-fill-check" viewBox="0 0 16 16">  <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm1.679-4.493-1.335 2.226a.75.75 0 0 1-1.174.144l-.774-.773a.5.5 0 0 1 .708-.708l.547.548 1.17-1.951a.5.5 0 1 1 .858.514ZM11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>  
