    ...
    <div className='fixed-bottom mx-5' align="center">
      <ul className={`nav justify-content-center bg-light border ${builder["cus-width"]}`}>
        <li className="nav-item mx-3">
            ...
            >
            <button className={form.grid===1?"btn btn-primary p-3":"btn btn-outline-primary p-3"} onClick={() => setForm({...form, ["grid"]:1})}>
        ...
        <li className="nav-item mx-3">
            ...
            >
            <button className={form.grid===2?"btn btn-primary p-3":"btn btn-outline-primary p-3"}  onClick={() => setForm({...form, ["grid"]:2})}>
        ...
        <li className="nav-item mx-3">
            ...
            >
            <button className={form.grid===3?"btn btn-primary p-3":"btn btn-outline-primary p-3"}  onClick={() => setForm({...form, ["grid"]:3})}>
