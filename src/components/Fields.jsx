...
export default function Fields() {
      ...
      return (
        <aside className={`${builder["icons-inner"]}`}>
                <div className="bg-primary">
                    <OverlayTrigger
                        ...
                        >
                        <button className="btn btn-light mx-2 my-2 mt-3" 
                            onClick={() => setForm({ ...form, ["fields"]: [...form.fields,fields.input]})}
                            onDragEnd={() => drop(fields.input)}
                            draggable>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-input-cursor-text" viewBox="0 0 16 16">
                    ...
                    <OverlayTrigger
                        ...
                        <button className="btn btn-light mx-2 my-2" 
                            ...
                            draggable>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-sliders" viewBox="0 0 16 16">
                    ...
                    <OverlayTrigger
                        ...
                        <button className="btn btn-light mx-2 my-2" 
                            ...
                            draggable>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-align-bottom" viewBox="0 0 16 16">
